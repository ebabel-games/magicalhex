...
function init() {
    ...
    rockGeometry.vertices.push(new THREE.Vector3(-10, -10, 0));         // 1.blue     0x0000ff
    rockGeometry.vertices.push(new THREE.Vector3(10, -10, 0));          // 2.red      0xff0000
    rockGeometry.vertices.push(new THREE.Vector3(5, -10, -30));         // 3.green    0x00ff00
    ...
    rockGeometry.faces[0].vertexColors = [white, blue, red];

    rockGeometry.faces.push(new THREE.Face3(0, 2, 3));  // Right
    rockGeometry.faces[1].vertexColors = [white, red, green];
