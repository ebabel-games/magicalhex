define(
  ...
  // A zone band is a horizontal collection of 10 randomly selected areas
  // accross the width of a zone.
  // pool: Pool of areas that can randomly be selected from. Each area has
  // a weight, which represents how likely that area is to be picked.
    const zoneBand = (pool = [
    ...
    // An area is a small portion of a zone, 50 by 50 coordinates, and each coordinate
    // is a square of 2m by 2m, and can be randomly picked to make up a portion of a zone.
